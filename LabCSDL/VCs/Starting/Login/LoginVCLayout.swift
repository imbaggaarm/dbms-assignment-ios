...
class LoginVCLayout: BaseViewControllerLayout {
    ...
    override func setUpLayout() {
        ...
        loginView.addSameConstraintsWith(format: "H:|-10-[v0]-10-|", for: txtFEmail, txtFPassword)
        ...
        btnLogin.layer.cornerRadius = AppConstant.heightOfLoginButton/2
        btnLogin.width(constant: widthOfScreen/2)
        btnLogin.centerXAnchor(with: loginView)
        btnLogin.setIndicatorViewFrame(width: widthOfScreen/2, height: AppConstant.heightOfLoginButton)
