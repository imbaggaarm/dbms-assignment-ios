...
extension UITabBarController {
    ...
    func createNVC(vc: UIViewController, title: String, backgroundColor: UIColor = .black, icon: UIImage?) -> UINavigationController {
        vc.navigationItem.title = title
        let nvc = UINavigationController.init(rootViewController: vc)
        nvc.view.backgroundColor = backgroundColor
...
extension UINavigationBar {
    static func setUpDefaultBar(tintColor: UIColor, barTintColor: UIColor, isTranslucent: Bool) {
